...
const prodOutput = [
  { exports, file: 'dist/nuxt-styled-components.min.js', format: 'umd', name: moduleName }
]

const devOutput = [
  { exports, file: 'dist/nuxt-styled-components.js', format: 'umd', name: moduleName },
  { exports, file: 'dist/nuxt-styled-components.es.js', format: 'es', name: moduleName }
]
