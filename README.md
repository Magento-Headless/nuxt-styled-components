# nuxt-styled-components

> Visual primitives for the component age. Use the best bits of ES6 and CSS to style your apps without stress 💅

## Support

> This version is compatible with Nuxt 2.x, Vue 2.x

```
yarn add nuxt-styled-components
```
...
```JS
import styled from 'nuxt-styled-components';
...
`nuxt-styled-components` has full theming support by exporting a `<ThemeProvider>` wrapper component. This component provides a theme to all `Vue` components underneath itself via the context API. In the render tree all `nuxt-styled-components` will have access to the provided theme, even when they are multiple levels deep.

Remember to register `ThemeProvider` locally.

```JSX
  import {ThemeProvider} from 'nuxt-styled-components'
...
import { injectGlobal } from 'nuxt-styled-components';
